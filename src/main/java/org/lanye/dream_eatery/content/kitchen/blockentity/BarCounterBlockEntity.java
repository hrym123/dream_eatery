package org.lanye.dream_eatery.content.kitchen.blockentity;
...
/** 吧台：GeckoLib 静态模型（含 {@code animation.bar_counter.idle} 占位）。 */
public class BarCounterBlockEntity extends BlockEntity implements GeoBlockEntity {

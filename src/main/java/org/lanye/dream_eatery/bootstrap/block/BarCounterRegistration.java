...
public final class BarCounterRegistration {
        ...
        for (BarMaterialVariant variant : BarMaterialVariant.VALUES) {
            ...
            RegistryObject<Block> ro =
                    ModBlocks.BLOCKS.register(
                            ...
                            () -> new BarCounterBlock(KitchenBlockProperties.woodCabinetNoOcclusion(), v));
                            ...
                            () ->
                                    new GeolibBlockItem(
                                            ...
                                            GeolibItemAssets.blockAssetWithTexture(
                                                    org.lanye.dream_eatery.DreamEatery.MODID,
                                                    GEO_STEM,
                                                    v.textureStem()))));
        }
        return List.copyOf(list);
    ...
    /** 触发 static 初始化（由 {@link KitchenAnimatedBlocks} 引用）。 */
